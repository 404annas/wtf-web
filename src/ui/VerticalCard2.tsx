...
const VerticalCard2 = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#C53B3A] flex flex-col items-center pt-10 lg:pt-4">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 pt-30 lg:pt-6">
        ...
        <div className="w-full max-w-[83%] h-[6px] md:h-[10px] -translate-y-0 lg:-translate-y-2 bg-white mb-4" />

        {/* 3. Description Paragraph */}
        <p className="max-w-2xl text-center text-white text-sm sm:text-base md:text-lg font-light leading-normal mb-10 text-balance">
          Advanced AI and human creativity blend to craft visuals, video, and copy at scale. Faster delivery, sharper quality, and powerful brand storytelling.
        </p>
