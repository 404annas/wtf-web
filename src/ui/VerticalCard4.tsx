...
const VerticalCard4 = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#F1B333] flex flex-col items-center pt-4">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4">
        ...
        <div className="w-full max-w-[40%] h-[6px] md:h-[10px] -translate-y-4 bg-[#2A2A2A] mb-4" />

        {/* 3. Description Paragraph */}
        <p className="max-w-3xl text-center text-[#2A2A2A] text-base md:text-lg font-light leading-normal mb-10 text-balance">
