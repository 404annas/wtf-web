  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#F1B333] flex flex-col items-center pt-10 lg:pt-4">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 pt-30 lg:pt-6">
        ...
        <div className="w-full max-w-[86%] h-[6px] md:h-[10px] -translate-y-0 lg:-translate-y-2 bg-[#2A2A2A] mb-4" />
        ...
        <p className="max-w-3xl text-center text-[#2A2A2A] text-sm sm:text-base md:text-lg font-light leading-normal mb-10 text-balance">
          A space for creators and brands ready to grow with intention. Not just services. Not one-off projects. An ecosystem supporting vision with strategy, resources, and meaningful connections.
        </p>
